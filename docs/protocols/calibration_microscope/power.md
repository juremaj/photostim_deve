...
3) This will generate a calibration curve saved in `photostim_deve/utils/calibration_power` as a `.png` file with the same name as the data (e. g. `2025-10-10_pockels.png`). See below how this plot should look:
